...
public class CmsStatistic {
	...
	public static final int STATISTIC_BY_DAY = 0;
	public static final int STATISTIC_BY_WEEK = 1;
	public static final int STATISTIC_BY_MONTH = 2;
	public static final int STATISTIC_BY_YEAR = 3;
	public static final int STATISTIC_BY_YEARS = 4;
	public static final int STATISTIC_BY_SECTION = 5;
	public static final int STATISTIC_BY_YESTERDAY = 6;
	
	
	public static final Integer ORDER_BY_TIME_DESC = 0;
	public static final Integer ORDER_BY_DATA_DESC = 1;
