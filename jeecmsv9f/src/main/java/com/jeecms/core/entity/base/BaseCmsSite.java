...
public abstract class BaseCmsSite  implements Serializable {
	...
	private com.jeecms.core.entity.CmsOss uploadOss;
	private com.jeecms.core.entity.CmsConfig config;
	// one to one
	private com.jeecms.core.entity.CmsSiteCompany siteCompany;

	// collections
	private java.util.Set<CmsSite>refers;
	private java.util.Set<CmsSite> toRefers;
	...
	public com.jeecms.core.entity.CmsOss getUploadOss() {
		return uploadOss;
	}

	public void setUploadOss(com.jeecms.core.entity.CmsOss uploadOss) {
	...
	public java.util.Set<CmsSite> getRefers() {
		return refers;
	}

	public void setRefers(java.util.Set<CmsSite> refers) {
		this.refers = refers;
	}

	public java.util.Set<CmsSite> getToRefers() {
		return toRefers;
	}

	public void setToRefers(java.util.Set<CmsSite> toRefers) {
		this.toRefers = toRefers;
	}
