...
public abstract class BaseCmsConfig  implements Serializable {
	...
	private java.lang.Integer validateType;
	private java.lang.Boolean viewOnlyChecked;
	private java.util.Date flowClearTime;
	private java.util.Date channelCountClearTime;
	private java.lang.Integer dayCount;
	private Long smsID;
	...
	public java.lang.Integer getValidateType() {
		return validateType;
	}

	public void setValidateType(java.lang.Integer validateType) {
	...
	public java.util.Date getFlowClearTime() {
		return flowClearTime;
	}

	public void setFlowClearTime(java.util.Date flowClearTime) {
		this.flowClearTime = flowClearTime;
	}
	
	public java.util.Date getChannelCountClearTime() {
		return channelCountClearTime;
	}

	public void setChannelCountClearTime(java.util.Date channelCountClearTime) {
