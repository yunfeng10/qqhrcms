...
alter table jc_oss add column end_point varchar(255) NOT NULL DEFAULT '' COMMENT 'end_point';
alter table jc_oss add column access_domain varchar(255) NOT NULL DEFAULT '' COMMENT '访问域名';
...
alter table jc_user add column  is_viewonly_admin tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否只读管理员';
